...
let description_text1: string = "Animania is a vast and immersive anime library that offers a wide range of anime content for fans of all ages and interests. From classic series to the latest releases, Animania has something for everyone.";
let description_text2: string = "Whether you're looking to express yourself with witty one-liners, hilarious images, or clever wordplay, MemeLab has got you covered. With its intuitive design and seamless functionality, you can create and share your favorite memes with just a few clicks.";
let description_text3: string = "ChapterCorner is a vibrant and user-friendly online book library and shop designed for book enthusiasts of all ages. With a vast collection of books across all genres, we offer a one-stop solution for all your literary needs.";
