...
const BooksPage = () => {
  return (
    <>
      <Navbar />
      <UniversalHeader height={1720} block1_width={286} title_text={title_text3} description_text={description_text3} button_variant="primary" link_to_page="books" button_text="Explore" button_type="scroll" element_id_to_scroll="search-form" children={[
